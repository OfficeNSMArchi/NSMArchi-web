...
export const STAGES: Record<StageType, { key: number; ko: string; en: string; hint?: string }[]> = {
  design: [
    ...
    { key: 1, ko: "기획설계안",  en: "Idea",              hint: "프로젝트 목표/요구사항 정의, 현황 측량, 조사, 기획 설계" },
    { key: 2, ko: "계획설계안",  en: "Proposed",          hint: "건축 개념, 구조/MEP 개략, 계획안" },
    { key: 3, ko: "계획설계안",  en: "Proposed",          hint: "각 분야 조율, 기본설계 완성, 기본 심의" },
    { key: 4, ko: "실시설계완료", en: "Design Completed", hint: "실시설계, 시방서, 물량산출, 세부심의 및 허가" },
    { key: 5, ko: "실시설계완료", en: "Design Completed", hint: "실시설계 완료, 시공 준비" },
    { key: 6, ko: "준공",        en: "Completed",         hint: "준공, 사용승인, 인계" },
    { key: 7, ko: "유지관리",    en: "In Use",            hint: "사용후평가, 유지관리" },
  ],
  research: [
