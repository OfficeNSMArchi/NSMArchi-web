...
content:
  ...
  - type: image
    ...
    alt: Facade
  - type: text
    titleKo: 임대 주거의 새로운 전형(Typology) 탐구.
    titleEn: Exploration for the new typology of rented house
    bodyKo: |
    ...
    bodyEn: |
      Exploring a new typology for rental housing. We aimed to propose a higher standard for private rental living by moving beyond uniform conventions and focusing on the essential values of high-end residential architecture.
  - type: image
    src: 02-interior.png
    alt: Interior
  - type: text
    titleKo: 물성과 디테일
    titleEn: Material & Detail
    bodyKo: |
    ...
    bodyEn: |
      Envelope: Spanish limestone was selected to provide a lasting, time-responsive presence.
