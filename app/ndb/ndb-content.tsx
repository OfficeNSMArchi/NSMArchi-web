...
import { useNdbCategory } from '@/components/ndb-category-provider';
...
const services = [
  {
    title: "BIM 설계지원",
    description: "현상설계, 기본/실시설계 도서작성 및 간섭체크를 지원합니다.",
    icon: <Layout className="w-6 h-6" />
  },
  {
    title: "BIM 코디네이션",
    description: "업무 프로세스 개선 및 설계오류 검토를 통한 품질을 확보합니다.",
    icon: <Box className="w-6 h-6" />
  },
  {
    title: "시각화 지원",
    description: "첨단 디지털 기술을 활용한 혁신적인 계획 프로세스를 제시합니다.",
    icon: <PenTool className="w-6 h-6" />
  },
  {
    title: "엔지니어링",
    description: "시공성 및 물량 검토를 위한 최적화된 솔루션을 제공합니다.",
    icon: <Building2 className="w-6 h-6" />
  }
];

const featuredProjects = [
  { title: "카타르 루사일 플라자 타워", category: "Global Landmark", year: "2020" },
  { title: "삼성전자 평택캠퍼스 사무2동", category: "High-Tech", year: "2019" },
  { title: "한국은행 본관 통합별관", category: "Public", year: "2017" },
  { title: "경주 화백컨벤션센터", category: "Convention", year: "2011" },
  { title: "용인시민체육공원", category: "Sports", year: "2009" }
];
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-slate-400 font-light leading-relaxed mb-10">
              ...
              첨단 BIM 기술 기반의 엔지니어링 솔루션을 제공합니다.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20">
            <div>
              ...
              <p className="text-slate-500">BIM 설계 프로세스를 적용한 혁신적인 업무 영역</p>
            </div>
          </div>
      ...
      <section id="about" className="py-32 bg-slate-950 text-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="text-5xl font-bold mb-2">김상환</h2>
